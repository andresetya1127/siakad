...
@section('content')
    ...
    <div class="col-12">
        <div class="card animate__animated animate__fadeInRight">
            <div class="card-body">
                <form action="{{ route('update.kurikulum', $kurikulum->id_kurikulum) }}" class="custom-validation"
                    method="POST" id="myform">
                    @csrf
                    <div class="row">
                        <div class="col-lg-6 col-md-6 col-sm-12 mb-3">
                            <label for="" class="form-label pt-0">Kurikulum</label>
                            <input class="form-control" type="text" value="{{ $kurikulum->nama_kurikulum }}"
                                name="nm_kurikulum" placeholder="Nama Kurikulum...">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12 mb-3">
                            ...
                            <select name="program_studi" class="select2 form-control" style="width: 100%;">
                                <option selected hidden>Program Studi</option>
                                <option value="55201" {{ $kurikulum->id_prodi == '55201' ? 'selected' : '' }}>Teknik
                                    Informatik
                                </option>
                                <option value="57201" {{ $kurikulum->id_prodi == '57201' ? 'selected' : '' }}>Sistem
                                    Informasi
                                </option>
                            </select>
                            <span class="error"></span>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-12 mb-3">
                            ...
                            <input class="form-control" type="number" value="{{ $kurikulum->jumlah_sks_wajib }}"
                                name="sks_wajib" placeholder="Jumlah SKS wajib...">
                            <span class="error"></span>
                        </div>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-12 mb-3">
                            ...
                            <input class="form-control" type="number" name="sks_pilihan"
                                value="{{ $kurikulum->jumlah_sks_pilihan }}" placeholder="Jumlah SKS Pilihan...">
                            <span class="error"></span>
                        </div>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-12 mb-3">
                            ...
                            <select name="masa_berlaku" class="select2 form-control" style="width: 100%;">
                                ...
                                @foreach ($semester as $smt)
                                    <option
                                        value="{{ $smt->semester }}"{{ $kurikulum->id_semester == $smt->semester ? 'selected' : '' }}>
                                        {{ $smt->nama_semester }}</option>
                                @endforeach
                            </select>
                            <span class="error"></span>
                        </div>
