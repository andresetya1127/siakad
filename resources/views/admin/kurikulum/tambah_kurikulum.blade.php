            ...
            <form action="{{ route('save.kurikulum') }}" class="custom-validation" method="POST" id="myform">
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-6 col-sm-12 mb-3">
                        ...
                        <input class="form-control" type="text" value="{{ old('nm_kurikulum') }}" name="nm_kurikulum" placeholder="Nama Kurikulum...">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 mb-3">
                        ...
                        <input class="form-control" type="number" value="{{ old('sks_wajib') }}" name="sks_wajib" placeholder="Jumlah SKS wajib...">
                        <span class="error"></span>
                    </div>

                    <div class="col-lg-4 col-md-6 col-sm-12 mb-3">
                        <label for="" class="form-label pt-0">Jumlah SKS(*pilihan)</label>
                        <input class="form-control" type="number" name="sks_pilihan" placeholder="Jumlah SKS Pilihan...">
                        <span class="error"></span>
                    </div>
